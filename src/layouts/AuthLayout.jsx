...
const AuthLayout = ({ children }) => {
  return (
    <div className="min-h-screen flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden bg-[#34155E] flex-col items-center justify-center p-16">

        {/* Orbes decorativos de fondo */}
        <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-[#EE531F] rounded-full opacity-20 blur-[80px] animate-pulse" />
        <div className="absolute -bottom-32 -right-32 w-[400px] h-[400px] bg-[#F9A825] rounded-full opacity-15 blur-[80px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#4a2080] rounded-full opacity-30 blur-[100px]" />
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h1 className="text-4xl font-black text-white mb-4 leading-tight">
            Sistema de<br />
            <span className="text-[#F9A825]">Reportes</span>
          </h1>
      ...
      <div className="flex-1 flex items-center justify-center bg-[#F8F9FC] p-8 relative overflow-hidden">
        {/* Orbe decorativo sutil */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#34155E] rounded-full opacity-5 blur-[60px]" />
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-xl overflow-hidden bg-[#34155E] flex items-center justify-center">
              <img src="/logo.svg" alt="AprendeLoPE" className="w-full h-full object-cover" />
            </div>
            <span className="font-bold text-[#34155E] text-lg">AprendeLoPE</span>
          </div>
